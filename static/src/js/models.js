...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        model:  'res.company',
        fields: [ 'currency_id', 'email', 'website', 'company_registry', 'vat', 'name', 'phone', 'partner_id' , 'country_id', 'tax_calculation_rounding_method', 'x_cai', 'x_rtn', 'x_rango1', 'x_rango2', 'x_fechalimite'],
    ...
    export_for_printing: function(){
        ...
        var receipt = {
            ...
            company:{
                ...
                x_cai: company.x_cai,
                x_rtn: company.x_rtn,
                x_rango1: company.x_rango1,
                x_rango2: company.x_rango2,
                x_fechalimite: company.x_fechalimite,
            },
            shop:{
                name: shop.name,
            },
